...
INSERT INTO `logs` VALUES (1,1,'2023-02-14','16:39:27','saida'),(2,1,'2023-02-14','19:07:27','saida'),(3,2,'2023-02-14','19:16:42','entrada'),(4,2,'2023-02-14','19:24:34','entrada'),(5,2,'2023-02-14','19:26:10','entrada'),(6,2,'2023-02-14','19:27:51','saida'),(7,2,'2023-02-14','19:29:13','saida'),(8,1,'2023-02-14','22:06:46','entrada'),(9,1,'2023-02-14','22:07:23','saida'),(10,1,'2023-02-14','22:27:41','saida'),(11,1,'2023-02-25','10:14:38','entrada'),(12,1,'2023-02-25','10:14:53','saida'),(13,1,'2023-02-25','11:28:31','saida'),(14,1,'2023-02-25','11:29:32','entrada'),(15,1,'2023-02-25','11:32:29','saida'),(16,1,'2023-02-25','11:34:23','saida'),(19,2,'2023-02-25','18:33:36','entrada'),(20,2,'2023-02-25','19:00:32','entrada'),(25,1,'2023-02-12','10:23:21','entrada'),(26,2,'2023-02-27','15:51:08','entrada'),(27,2,'2023-02-27','15:52:31','saida'),(28,2,'2023-02-27','15:52:48','entrada'),(29,2,'2023-02-27','15:53:31','saida'),(30,2,'2023-02-27','15:55:45','saida'),(31,2,'2023-02-27','15:56:09','saida'),(32,2,'2023-02-27','15:56:52','entrada'),(33,2,'2023-02-27','15:57:55','saida'),(34,2,'2023-02-27','15:58:18','entrada'),(35,2,'2023-02-27','15:58:36','entrada'),(36,2,'2023-02-27','16:03:03','saida'),(37,2,'2023-02-27','16:03:39','saida'),(38,2,'2023-02-27','16:04:02','entrada'),(39,2,'2023-02-27','16:04:38','entrada'),(40,2,'2023-02-27','16:04:53','saida'),(41,2,'2023-02-27','19:22:40','entrada');
/*!40000 ALTER TABLE `logs` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `perfil_cadastrados`
--

DROP TABLE IF EXISTS `perfil_cadastrados`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `perfil_cadastrados` (
  `codigo` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `perfil_cadastrados`
--

LOCK TABLES `perfil_cadastrados` WRITE;
/*!40000 ALTER TABLE `perfil_cadastrados` DISABLE KEYS */;
INSERT INTO `perfil_cadastrados` VALUES (1,'Nícholas','#FCSS1'),(2,'Henry','AB 7288');
/*!40000 ALTER TABLE `perfil_cadastrados` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-02-27 19:29:02
